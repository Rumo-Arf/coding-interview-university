...
구글 인터뷰 대학은 웹 개발자(컴퓨터공학 학위 없음, 독학)에서 구글의 소프트웨어 엔지니어가 되기 위한 나의 몇 달 간의 공부 계획이다.

![Coding at the whiteboard - from HBO's Silicon Valley](https://dng5l3qzreal6.cloudfront.net/2016/Aug/coding_board_small-1470866369118.jpg)

이 기나긴 리스트는 **구글 코칭 노트**에서 선별되고 확장된 것으로 여러분이 알아야 할 내용이다. 맨 아래에는 인터뷰에 등장하거나 문제를 푸는 데에 도움이 될 만한 추가적인 내용이 있다. Steve Yegge의  "[Get that job at Google](http://steve-yegge.blogspot.com/2008/03/get-that-job-at-google.html)"이라는 책에서 나왔으며, 때때로 구글 코칭 노트의 내용을 그대로 담고있기도 하다.
...
당신이 경력자라면, 인터뷰가 더 어려울 수도 있다. [더 보기](https://googleyasheck.com/what-you-need-to-know-for-your-google-interview-and-what-you-dont/).

당신이 소프트웨어/웹 개발 경험이 있다면, 구글, 아마존, 페이스북, MS 같은 거대 소프트웨어 기업들은 소프트웨어와 웹 개발은 다르다고 본다. 컴퓨터 공학적 지식을 쌓아야 한다.
실력있는 시스템 엔지니어가 되고 싶다면 네트워크, 보안 등 을 더 공부하도록 하자.
...
이 프로젝트를 시작했을 때, 나는 힙, 스택, Big-O, 트리, 그래프 운행 등에 대하여 전혀 아는 바가 없었다.
내가 정렬 알고리즘을 코딩 했다면, 그건 썩 좋은 코드는 아녔을 거다.
...
만약 이 내용 중에 익숙한게 있다면 그만큼 시간은 덜 들 것이다.

## 사용법

아래는 대략적인 개요이며 위에서 아래 순서대로 진행해야 한다.

Github'special markdown을 사용해서 진행 상황을 체크 할 수 있도록 했다.
